...
//console.log(path.resolve(__dirname, '../src/views/zeus/assets'));
//console.log(path.resolve(__dirname, '../dist/zeus'));
...
module.exports = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      {
        from: path.resolve(__dirname, '../src/views/zeus/assets'),
        to:  path.resolve(config.dev.assetsPublicPath, '/dist/zeus'),
        //ignore: ['.*']
      }
