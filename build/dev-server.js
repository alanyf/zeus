...
app.use('*', function (req, res, next) {
    if (req.get('x-requested-with') === 'XMLHttpRequest') {
        console.log(req.method, req.baseUrl, req.method.toLocaleUpperCase() === 'GET' ? req.query : req.body);
    }
    next();
});
...
app.use(mock);
const ipAdress = utils.getLocalIpAdress();
const uri = 'http://localhost:' + port + ' | http://' + ipAdress + ':' + port;
